...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ReusableScrollMenuView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/KIM EUIGYOM/ReusableScrollMenuView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'KIM EUIGYOM' => 'deholexp@gmail.com' }
  s.source           = { :git => 'https://github.com/KIM EUIGYOM/ReusableScrollMenuView.git', :tag => s.version.to_s }
